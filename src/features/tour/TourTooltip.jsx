...
export function TourTooltip({
  ...
  return (
    <div className="ds-tour-tooltip" {...tooltipProps}>
      ...
      <div className="ds-tour-body">{step.content}</div>
      ...
      <div className="ds-tour-footer">
        ...
        <div className="ds-tour-actions">
          {index > 0 && (
            <button type="button" className="ds-tour-btn ds-tour-btn-secondary" {...backProps}>
              Back
            </button>
          )}

          <button type="button" className="ds-tour-btn ds-tour-btn-primary" {...primaryProps} onClick={handlePrimary}>
